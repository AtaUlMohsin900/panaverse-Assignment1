...
a statement about each animal, such as A dog would make a great pet. • Add a line at the end of your program stating
 what these animals have in common. You could print a sentence such as Any of these animals would make a great pet!*/
var animals = ["Horse", "Goat", "cat"];
// Names of Animals
for (var i = 0; i < animals.length; i++) {
    console.warn(animals[i]);
}
// Statements about the Animals
for (var i = 0; i < animals.length; i++) {
    console.warn("a ".concat(animals[i], " is the very faithful animal."));
}
console.warn('All of these animals are faithful.');
